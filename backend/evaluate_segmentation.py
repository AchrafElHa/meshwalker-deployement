...
#   # models = {}
#   npz_path = 'datasets_processed/human_seg_from_meshcnn/test_shrec__1_not_changed_1500.npz'
...
#   accs, _ = calc_accuracy_test(logdir,dataset_expansion=dataset_expansion, file_path=npz_file)
#   print('Edge accuracy:', accs[0])
#   # return segmentation
